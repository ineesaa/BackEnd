...
// Simple cookie-based session (no JWT required per spec)
app.use(
  session({
...
app.use('/products',           productReviewRoutes); // /products/:id/reviews
...
// All unhandled async errors bubble up here via next(err).
