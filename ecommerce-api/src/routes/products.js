...
// GET /products
// Public. Supports ?category=, ?search=, ?page=, ?pageSize=, ?minPrice=, ?maxPrice=, ?inStock=
router.get('/', async (req, res, next) => {
  try {
    ...
    // Bonus: case-insensitive search across name and description
    if (search) {
      where.OR = [
...
// GET /products/:id — public, includes categories + reviews
...
// Body: { name, description?, price, stock?, categoryIds?: number[] }
...
// Body: any subset of { name, description, price, stock, categoryIds }
